...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2024 at 07:32 AM
...
(8, 'pbkdf2_sha256$720000$0ug6cwcbeUd3W9ssxDvOVX$AXFF5mHob3HWfPoqMzWUlx3BG1AkAkcoPACKwFv2wUY=', '2024-07-24 03:48:09.394818', 1, 'Developtrees', '', '', 'reecha.arava@developtrees.com', 1, 1, '2024-07-23 11:45:45.084012');
...
(1, 'New User Offer!', 'Valid Until: All Days Except Monday.', 'Coupon Code: FIRSTBUS.', 'images/new_user1.jpg');
...
(4, '', 'The discount will be credited instantly with the booking amount while making the transaction.'),
...
(34, '', 'Offer is only valid on the Bus only.', ''),
...
(1, 'How do you get it ?', 'To avail the discount, users have to book bus tickets for their preferred destination by applying coupon code that is displayed on the page.', ''),
...
(1, 'images/ayyodhyaaaa.png', 'Ayodhya Travel Guide.', 'Upto Rs.500 off on Bus Bookings.', 'Discount: 5% offer.', 'Valid Until: Every Fri,Sat,Sun.', 'BUSWEEKENDS', 'http://127.0.0.1:8000/bus_main1/'),
(2, 'images/steal_the_deals.png', 'Steal the Deal.', 'Save Upto Rs.300 on Bus Bookings.', 'Discount: Get 50% Cashback.', 'Valid Until: Limited Period.', 'GO50', 'http://127.0.0.1:8000/bus_main2/'),
(3, 'images/plan_your_trip_with_us.png', 'Plan your Trip With Us!', 'Offer on Festival Save Upto Rs.900.', 'Discount 30% offer.', 'Valid Until: February 25, 2024.', 'FESTIVALBUS', 'http://127.0.0.1:8000/bus_main3/'),
(4, 'images/Travellings_in_India_1.png', 'Travellings in India?', 'Get FLAT Rs. 250 OFF on Buses.', 'Discount: 15% offer.', 'Valid Until: Limited Period.', 'SPECIAL25', 'http://127.0.0.1:8000/bus_main4/'),
(5, 'images/New_user_1.png', 'New User Offer!', 'Upto Rs.210 off on First Booking.', 'Discount: 20% offer.', 'Valid Until: All Days Except Monday.', 'FIRSTBUS', 'http://127.0.0.1:8000/bus_main5/'),
(6, 'images/MEGA_DEALS_3.png', 'Mega Deals on Booking!', 'Applicable For All Users FLAT Rs.100.', 'Discount: 10% offer.', 'Valid Until: Limited Period Offer.', 'BUSDAY', 'http://127.0.0.1:8000/bus_main6/'),
(7, 'images/deal_of_the_day.png', 'Deal of the Day.', 'Enjoy Different Deals Each Day.', 'Discount: Minimum 10% offer.', 'Valid until: Only Sunday, Monday.', 'EASEDAY', 'http://127.0.0.1:8000/bus_main8/'),
(8, 'images/special_offer_of_the_week_1.png', 'Special Offer of the Week.', 'Flat ₹120 offer + 100 Cashback.', 'Discount: 12% offer.', 'Valid until: Limited Time Period.', 'WEEKDAY', 'http://127.0.0.1:8000/bus_main9/'),
(9, 'images/travel_party_1.png', 'Travel Party.', 'Upto 15% on all Bus Booking.', 'Discount: 15% offer.', 'Valid Until: Only this month.', 'OFFER12', 'http://127.0.0.1:8000/bus_main11/'),
(10, 'images/ganesha_offer.png', 'Ganesha Offer !', 'Upto ₹500/-* on Bus Tickets.', 'Discount: Get Instant discount.', 'Valid Until: Limited period.', 'FEST24', 'http://127.0.0.1:8000/bus_main13/'),
(11, 'images/Bank_offer.png', 'Bank Offer !', 'Grab Upto ₹1000/-* on Bus Tickets.', 'Discount: Get 40% offer.', 'Valid Until: Limited period.', 'ICICITD', 'http://127.0.0.1:8000/bus_main14/'),
(12, 'images/Holiday_packages.png', 'Holiday Packages !', 'Save Upto ₹2000 Per Person.', 'Discount: 20% offer.', 'Valid Until: Limited period.', 'HOLIDAY20', 'http://127.0.0.1:8000/bus_main15/'),
(13, 'images/Ride_more_save_more_2.png', 'Ride More Save More!', 'Instant Discount ₹300 on Bus Booking.', 'Discount: 8% offer.', 'Valid until: Limited Time Period.', 'RIDE10', 'http://127.0.0.1:8000/bus_main7/');
...
(1, 'We Are About Teerdha', 'Teerdha is the best platform for booking bus tickets online. Teerdha will serve around the country and will be launching bus ticket booking services in more countries. Trusted by over 17 million customers, Teerdha offers an easy, fast, and secure platform for booking cheap bus tickets. You only need to select your origin, destination, and date of departure and you will find plenty of buses to travel by within a few seconds. You can book a bus based on your preferred schedule, choose a pick-up and drop-off, your preferred bus type and book a bus ticket online with just a few clicks!'),
...
(3, '', 'What else do you need to know ?', 'The cashback offer is valid for a limited period, subject to Paytm\'s discretion.', 'Users must comply with the offer terms and conditions to qualify for cashback rewards.', 'Cashback amounts may vary based on transaction amounts, offer duration and other factors.', 'Paytm reserves the right to modify or withdraw the offer without prior notice.', 'Users are encouraged to update their Paytm app to access the latest offers and features.', '', '', '', '', 'For any queries or assistance regarding the cashback offer, users can contact Paytm customer support.', '', ''),
...
(1, 'Grab up to 12% OFF* on Flights.', 'USECODE: TRDKOTAK', 'images/KOTAK_atJJYwA.png', '', 'http://127.0.0.1:8000/kotak/'),
(2, 'Enjoy Discounts on Flights with Axis Bank.', 'USECODE: TEDAXIS', 'images/TEDAXIS_1_8VzLDGp.png', '', 'http://127.0.0.1:8000/axis/'),
(3, 'Book flights with 100% refund on cancellation.', 'USECODE: TRDDOM', 'images/buy.png', '', 'http://127.0.0.1:8000/zerocancellation/'),
(4, 'Grab 12% OFF* on Yesbank Credit cards.', 'USECODE: TRDYB', 'images/TRDYB_cTYwj4y.png', '', 'http://127.0.0.1:8000/yes_bank_offercard/'),
(5, 'Upto 2000/- on domestic flights.', 'USECODE: TRDHDFC', 'images/HDFCTED_1_6wh9PPe.png', '', 'http://127.0.0.1:8000/hdfc_offer_card/'),
(6, 'Grab FLAT 10% OFF* on Domestic Flights.', 'USECODE: TRDSBI', 'images/TRDSBI_2b9dP4A.png', '', 'http://127.0.0.1:8000/sbi/'),
(7, 'FLAT 12% OFF* on Domestic Flights.', 'USECODE: TRDICICI', 'images/icici_3_Z9arXO7.png', '', 'http://127.0.0.1:8000/icic/'),
(8, 'New user offer on your 1st flight.', 'USECODE: TEDFB1', 'images/tedfb1.png', '', 'http://127.0.0.1:8000/flight_offer_1');
...
(2, '', 'media/axisbank_offerscard2.png', 'Axis bank domestic and international flight offers', 'Flat 20% off on domestic & flat 15% off on International flights with axis bank.'),
...
(4, '', 'media/axisbank_offerscard4.png', 'Get exclusive discounts on International flights', 'Get a flat 7% off up to INR 4500 on International flight booking with axis bank.'),
(5, '', 'media/axisbank_offerscard5.png', 'Get exclusive discounts on domestic flights', 'Get a flat 8% off up to INR 1500 on domestic flight booking with axis bank.'),
(6, 'Do not Miss Out on Exciting Travel Deals with Axis Bank', '', '', '');
...
(2, 'About The Offer', 'images/icici_terdha.png', 'Book your domestic flight and get a flat 12% off on payments via ICICI Bank Credit\ncards.', 'TRDICICI', '', '');
...
--
-- Table structure for table `booking_profile`
--
...
('aqupn0f609uufekvcvvl5w14lro60961', '.eJxVjMsOwiAQRf-FtSEUy2Ncuu83kIEZpGogKe3K-O_apAvd3nPOfYmA21rC1nkJM4mL8OL0u0VMD647oDvWW5Op1XWZo9wVedAup0b8vB7u30HBXr71GZizJ0Mja6UYso_WgvOgLCA40ETEmNA7M0QwrJiix2HMGpGBnHh_APpOOMI:1sWSz3:UGf7XSLHk6X42RAvegZgS3GlS73il_3bC4FfM22MZzM', '2024-08-07 03:48:09.405232'),
...
--
-- Indexes for table `booking_profile`
--
ALTER TABLE `booking_profile`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `booking_profile`
--
ALTER TABLE `booking_profile`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
